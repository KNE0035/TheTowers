 ...
 * @author marek
 */
public class PhotonBall extends Projectile{
    private static final int SPEED = 10;
    private static final ArmorType ARMOR_COUNTER = ArmorType.HEAVY;
    private static final int VIEW_IDENTIFIKATOR = R.drawable.photon_ball;
    
    public PhotonBall(PointF position, PointF imageOffset, Unit lockedEnemy, int damage) {
